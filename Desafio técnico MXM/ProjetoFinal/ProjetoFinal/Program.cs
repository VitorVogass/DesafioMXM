...
{
    static string diretorioEntrada;
    static string diretorioSaida;
    ...
    static void ConfigurarDiretorios()
    {
        Console.WriteLine("Por favor, insira o diretório de entrada:");
        diretorioEntrada = Console.ReadLine();

        Console.WriteLine("Por favor, insira o diretório de saída:");
        diretorioSaida = Console.ReadLine();

        if (!Directory.Exists(diretorioEntrada) || !Directory.Exists(diretorioSaida))
        {
            Console.WriteLine("Um ou ambos os diretórios fornecidos não existem. Por favor, verifique e tente novamente.");
        }
    }
